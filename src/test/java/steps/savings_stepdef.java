...
public class savings_stepdef {
    ...
    public void i_enter_username_and_password() {
        ...
        bankComponent.enterUsername("admin123@gmail.com");
        bankComponent.enterPassword("Admin@123");
    ...
    @Then("Validate Search box with TRN")
    public void validate_search_box_with_trn() throws InterruptedException {
        // Implement validation code for Search box with TRN
    	bankComponent.searchTransactionDetails("486174274");
    	 driver.findElement(By.xpath("//*[@id=\"transactionTable_filter\"]/label/input")).clear();
    	 logger.info("User is entering to Validate Search box with  TRN");

    	 test.pass("Validate sarch box with  TRN");
    }
